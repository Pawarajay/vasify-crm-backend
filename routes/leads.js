...
//       const [leads] = await pool.execute(
//         "SELECT * FROM leads WHERE id = ?",
//         [id] // Fixed: direct array, no sanitizeParams for single ID
//       );
...
//         const service = customerData.service || lead.service || null;
//         const address = customerData.address || lead.address || null;

//         // FIXED: Direct array parameters matching EXACTLY 14 columns
//         await connection.execute(
//           `
//           INSERT INTO customers (
...
//             customerId,
//             customerData.name || lead.name,
//             lead.email || null,  // Ensure email can be null
//             customerData.phone || lead.phone || null,
//             customerData.company || lead.company || null,
//             address,
//             "active",
//             lead.source || null,
//             assignedTo,
//             JSON.stringify(tagsArray),
//             customerData.notes || lead.notes || null,
//             parseFloat(customerData.totalValue || lead.estimated_value || 0),
//             customerData.whatsappNumber || lead.whatsapp_number || null,
//             service
//           ]
//         );
...
//         if (customer.tags && typeof customer.tags === "string") {
//           try {
//             customer.tags = customer.tags.trim() !== "" ? JSON.parse(customer.tags) : [];
//           } catch (e) {
...
//       res.status(500).json({ error: "Failed to convert lead to customer", details: error.message });
//     }
//   }
// );
