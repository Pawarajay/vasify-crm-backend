...
//       default_renewal_reminder_days,
//       default_renewal_notes
//       -- created_at, updated_at are omitted to use defaults
//     )
//     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
//   `,
//   sanitizeParams(
...
//     defaultRenewalReminderDays, // 33
//     defaultRenewalNotes         // 34
//     // 34 values for 34 listed columns (1–34)
//   )
// );
...
// // ✅ UPDATED CREATE new customer (with leadId support)
// router.post(
//   "/",
//   authenticateToken,
//   [
...
//         monthlyPrice,
//         manualPrice,
//         leadId, // ✅ NEW: Lead origin tracking
...
//       // ✅ NEW: Auto-populate service from lead if leadId provided and no service
...
//         } else {
//           console.warn(`Lead ${leadId} not found or has no service`);
//         }
//       }
...
//           defaultInvoiceNotes,                  // 23
//           whatsappNumber,                       // 24
//           service,                              // 25 ✅ AUTO-FILLED FROM LEAD
//           serviceType || null,                  // 26 ✅ AUTO-FILLED FROM LEAD
//           recurringEnabled ? 1 : 0,             // 27
//           recurringInterval || "monthly",       // 28
//           recurringAmount,                      // 29
//           recurringService,                     // 30
...
//       res.status(201).json({
//         message: `Customer created successfully${leadId ? ` from lead #${leadId}` : ""}`,
//         customer,
//       });
//     } catch (error) {
//       console.error("Customer creation error:", error);
